<?php
	...
	$rental_items = $controller->generateLibraryStatusReport();
									...
									<tr>
										...
										<td>
											<?php switch ($rental_item->getStatus()) {
												case \LIS\RentalItem\RentalItem::STATUS_DAMAGED:
													echo "Damaged";
													break;

												case \LIS\RentalItem\RentalItem::STATUS_LOST:
													echo "Lost";
													break;

												case \LIS\RentalItem\RentalItem::STATUS_REMOVED:
													echo "Removed";
													break;
											}
											?>
