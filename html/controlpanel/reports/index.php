					...
					<div class="center col-lg-8 col-md-8 col-sm-10 col-lg-offset-2 col-md-offset-2 col-sm-offset-1">
						...
						<div class="row">
							<div class="col-sm-6 col-md-4">
								<div class="thumbnail">
									<a href="item">
										<img src="/assets/images/magazine_stack.jpg" alt="Rental Item Report">
									</a>
									<div class="caption">
										<a href="item" class="btn btn-primary center-block"
										   role="button">Rental Item Report</a>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-md-4">
								<div class="thumbnail">
									<a href="user">
										<img src="/assets/images/book_shelf.jpg" alt="User Report">
									</a>
									<div class="caption">
										<a href="user" class="btn btn-primary center-block"
										   role="button">User Report</a>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-md-4">
								<div class="thumbnail">
									<a href="status">
										<img src="/assets/images/dvds.jpg" alt="Library Status Report">
									</a>
									<div class="caption">
										<a href="status" class="btn btn-primary center-block"
										   role="button">Library Status Report</a>
									</div>
								</div>
							</div>
						</div>
