<?php
	...
	if (\LIS\Utility::requestHasPost())
		...
		$controller->createNewBook($_POST["summary"], $_POST["title"], $_POST["category"], $_POST["date_published"], $_POST["isbn10"], $_POST["isbn13"], $_POST["authors"]);
					...
					<form action method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="summary" name="summary"
							       placeholder="Add a summary for the book" value="<?= $_POST["summary"] ?>">
						</div>
						<div class="form-group">
							<label for="category">Category</label>
							<input type="text" class="form-control" id="category" name="category"
							       placeholder="Fiction" value="<?= $_POST["category"] ?>">
						</div>
						<div class="form-group">
							<label for="isbn10">ISBN10</label>
							<input type="text" class="form-control" id="isbn10" name="isbn10"
							       placeholder="8931001990" value="<?= $_POST["isbn10"] ?>">
						</div>

						<div class="form-group">
							<label for="isbn13">ISBN13</label>
							<input type="text" class="form-control" id="isbn13" name="isbn13"
							       placeholder="9788931001990" value="<?= $_POST["isbn13"] ?>">
						</div>
